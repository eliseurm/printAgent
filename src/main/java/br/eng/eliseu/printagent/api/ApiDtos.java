...
public final class ApiDtos {
    ...
    public record EnvelopeRespostaDTO<T>(boolean sucesso,String mensagem,T dados,List<ErroDTO> erros,OffsetDateTime dataHora) {
        public static <T> EnvelopeRespostaDTO<T> sucesso(String mensagem,T dados){return new EnvelopeRespostaDTO<>(true,mensagem,dados,List.of(),OffsetDateTime.now());}
        public static EnvelopeRespostaDTO<Map<String,Object>> erro(String mensagem,List<ErroDTO> erros){return new EnvelopeRespostaDTO<>(false,mensagem,Map.of(),erros,OffsetDateTime.now());}
    }
    ...
    public record TrabalhoConsultaResponseDTO(String idTrabalho,String nome,String impressora,String tipoConteudo,Integer copias,String status,OffsetDateTime dataCriacao,OffsetDateTime dataInicio,OffsetDateTime dataTermino,String mensagemErro) {}
